 ...
 */
define("DB_USER", 'bocuso_database');
define("DB_PASSWORD", 'Ma4V77HurT2EWB');
define("DB_NAME", 'bocuso_database');
...
class Backup_Database {
     ...
     */
     public function email_file(){
        ...
        // (A) EMAIL SETTINGS
        $mailTo = "onfurob@gmail.com";
        $mailSubject = "PickPackWave Database Backup";
        $mailMessage = "<strong>PickPackWave Database Backup!</strong>";
        $mailAttach = $filename;

        // Sender 
        $from = 'parth.onfuro@gmail.com'; 
        $fromName = 'PickPackWave'; 
